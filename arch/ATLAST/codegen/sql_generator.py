...
class SQLGenerator():
  ...
  def visit(self, node):
    ...
    joinString = leftString + " JOIN " + rightString + " ON " + constraintString
    self._sql_from_stack.append(joinString)
  ...
  def visit(self, node):
    ...
    rightString = self._sql_where_stack.pop()
    leftString = self._sql_where_stack.pop()
    constraintString = "(" + leftString + ") AND " + "(" + rightString + ")"
    self._sql_where_stack.append(constraintString)
  ...
  def visit(self, node):
    ...
    rightString = self._sql_where_stack.pop()
    leftString = self._sql_where_stack.pop()
    constraintString = "(" + leftString + ") OR " + "(" + rightString + ")"
    self._sql_where_stack.append(constraintString)
